 ...
 *
 * This is the contract meant to be owned by MSCEngine. It is a ERC20 token that can be minted and burned by the MSCEngine smart contract.
 */
contract MockMoreDebtMSC is ERC20Burnable, Ownable {
    ...
    */
    constructor(address _mockAggregator) ERC20("MyStableCoin", "MSC") {
